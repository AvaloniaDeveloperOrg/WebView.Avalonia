namespace CefSharp.Core.Wrapper;

using BrowserRequestInfoMap = CefBrowserInfoMap<System.Collections.Generic.KeyValuePair<int, int>, CefSharp.Core.Wrapper.CefMessageRouterRendererSide.RequestInfo>;
