...
internal static unsafe partial class libcef
{
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_multimap_alloc", CallingConvention = CEF_CALL)]
    public static extern cef_string_multimap* string_multimap_alloc();

    // Return the number of elements in the string multimap.
    [DllImport(LibraryName, EntryPoint = "cef_string_multimap_size", CallingConvention = CEF_CALL)]
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_multimap_find_count", CallingConvention = CEF_CALL)]
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_multimap_enumerate", CallingConvention = CEF_CALL)]
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_multimap_key", CallingConvention = CEF_CALL)]
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_multimap_value", CallingConvention = CEF_CALL)]
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_multimap_append", CallingConvention = CEF_CALL)]
    public static extern int string_multimap_append(cef_string_multimap* map, cef_string_t* key, cef_string_t* value);

    // Clear the string multimap.
    [DllImport(LibraryName, EntryPoint = "cef_string_multimap_clear", CallingConvention = CEF_CALL)]
    public static extern void string_multimap_clear(cef_string_multimap* map);

    // Free the string multimap.
    [DllImport(LibraryName, EntryPoint = "cef_string_multimap_free", CallingConvention = CEF_CALL)]
