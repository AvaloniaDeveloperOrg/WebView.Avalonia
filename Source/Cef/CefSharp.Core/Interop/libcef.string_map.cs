...
internal static unsafe partial class libcef
{
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_map_alloc", CallingConvention = CEF_CALL)]
    public static extern cef_string_map* string_map_alloc();

    // Return the number of elements in the string map.
    [DllImport(LibraryName, EntryPoint = "cef_string_map_size", CallingConvention = CEF_CALL)]
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_map_find", CallingConvention = CEF_CALL)]
    public static extern int string_map_find(cef_string_map* map, cef_string_t* key, cef_string_t* value);

    // Return the key at the specified zero-based string map index.
    [DllImport(LibraryName, EntryPoint = "cef_string_map_key", CallingConvention = CEF_CALL)]
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_map_value", CallingConvention = CEF_CALL)]
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_map_append", CallingConvention = CEF_CALL)]
    public static extern int string_map_append(cef_string_map* map, cef_string_t* key, cef_string_t* value);

    // Clear the string map.
    [DllImport(LibraryName, EntryPoint = "cef_string_map_clear", CallingConvention = CEF_CALL)]
    public static extern void string_map_clear(cef_string_map* map);

    // Free the string map.
    [DllImport(LibraryName, EntryPoint = "cef_string_map_free", CallingConvention = CEF_CALL)]
