...
{
    [DllImport(LibraryName, EntryPoint = "cef_basetime_now", CallingConvention = CEF_CALL)]
    public static extern CefBaseTime basetime_now();

    [DllImport(LibraryName, EntryPoint = "cef_time_to_basetime", CallingConvention = CEF_CALL)]
    public static extern int time_to_basetime(in CefTime from, out CefBaseTime to);

    [DllImport(LibraryName, EntryPoint = "cef_time_from_basetime", CallingConvention = CEF_CALL)]
