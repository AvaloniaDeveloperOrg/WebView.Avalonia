...
internal static unsafe partial class libcef
{
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_utf16_set", CallingConvention = CEF_CALL)]
    public static extern int string_set(char* src, UIntPtr src_len, cef_string_t* output, int copy);


    // These functions clear string values. The structure itself is not freed.

    [DllImport(LibraryName, EntryPoint = "cef_string_utf16_clear", CallingConvention = CEF_CALL)]
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_userfree_utf16_alloc", CallingConvention = CEF_CALL)]
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_userfree_utf16_free", CallingConvention = CEF_CALL)]
