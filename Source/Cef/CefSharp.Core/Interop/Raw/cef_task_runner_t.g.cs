...
internal unsafe struct cef_task_runner_t
{
    ...
    // GetForCurrentThread
    [DllImport(libcef.LibraryName, EntryPoint = "cef_task_runner_get_for_current_thread", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_task_runner_t* get_for_current_thread();
    
    // GetForThread
    [DllImport(libcef.LibraryName, EntryPoint = "cef_task_runner_get_for_thread", CallingConvention = libcef.CEF_CALL)]
