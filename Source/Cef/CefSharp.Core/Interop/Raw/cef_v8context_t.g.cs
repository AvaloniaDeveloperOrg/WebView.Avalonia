...
internal unsafe struct cef_v8context_t
{
    ...
    // GetCurrentContext
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8context_get_current_context", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_v8context_t* get_current_context();
    
    // GetEnteredContext
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8context_get_entered_context", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_v8context_t* get_entered_context();
    
    // InContext
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8context_in_context", CallingConvention = libcef.CEF_CALL)]
