...
internal unsafe struct cef_browser_host_t
{
    ...
    // CreateBrowser
    [DllImport(libcef.LibraryName, EntryPoint = "cef_browser_host_create_browser", CallingConvention = libcef.CEF_CALL)]
    ...
    // CreateBrowserSync
    [DllImport(libcef.LibraryName, EntryPoint = "cef_browser_host_create_browser_sync", CallingConvention = libcef.CEF_CALL)]
