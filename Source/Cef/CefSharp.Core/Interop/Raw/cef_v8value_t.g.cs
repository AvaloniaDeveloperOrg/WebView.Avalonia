...
internal unsafe struct cef_v8value_t
{
    ...
    // CreateUndefined
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8value_create_undefined", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_v8value_t* create_undefined();
    
    // CreateNull
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8value_create_null", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_v8value_t* create_null();
    
    // CreateBool
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8value_create_bool", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_v8value_t* create_bool(int value);
    
    // CreateInt
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8value_create_int", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_v8value_t* create_int(int value);
    
    // CreateUInt
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8value_create_uint", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_v8value_t* create_uint(uint value);
    
    // CreateDouble
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8value_create_double", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_v8value_t* create_double(double value);
    
    // CreateDate
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8value_create_date", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_v8value_t* create_date(CefBaseTime date);
    
    // CreateString
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8value_create_string", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_v8value_t* create_string(cef_string_t* value);
    
    // CreateObject
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8value_create_object", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_v8value_t* create_object(cef_v8accessor_t* accessor, cef_v8interceptor_t* interceptor);
    
    // CreateArray
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8value_create_array", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_v8value_t* create_array(int length);
    
    // CreateArrayBuffer
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8value_create_array_buffer", CallingConvention = libcef.CEF_CALL)]
    ...
    // CreateFunction
    [DllImport(libcef.LibraryName, EntryPoint = "cef_v8value_create_function", CallingConvention = libcef.CEF_CALL)]
