...
internal unsafe struct cef_request_context_t
{
    ...
    // GetGlobalContext
    [DllImport(libcef.LibraryName, EntryPoint = "cef_request_context_get_global_context", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_request_context_t* get_global_context();
    
    // CreateContext
    [DllImport(libcef.LibraryName, EntryPoint = "cef_request_context_create_context", CallingConvention = libcef.CEF_CALL)]
    ...
    // CreateContext
    [DllImport(libcef.LibraryName, EntryPoint = "cef_create_context_shared", CallingConvention = libcef.CEF_CALL)]
