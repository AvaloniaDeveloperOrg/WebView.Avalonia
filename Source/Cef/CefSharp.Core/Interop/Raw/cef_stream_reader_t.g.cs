...
internal unsafe struct cef_stream_reader_t
{
    ...
    // CreateForFile
    [DllImport(libcef.LibraryName, EntryPoint = "cef_stream_reader_create_for_file", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_stream_reader_t* create_for_file(cef_string_t* fileName);
    
    // CreateForData
    [DllImport(libcef.LibraryName, EntryPoint = "cef_stream_reader_create_for_data", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_stream_reader_t* create_for_data(void* data, UIntPtr size);
    
    // CreateForHandler
    [DllImport(libcef.LibraryName, EntryPoint = "cef_stream_reader_create_for_handler", CallingConvention = libcef.CEF_CALL)]
