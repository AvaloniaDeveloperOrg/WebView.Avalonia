...
internal unsafe struct cef_stream_writer_t
{
    ...
    // CreateForFile
    [DllImport(libcef.LibraryName, EntryPoint = "cef_stream_writer_create_for_file", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_stream_writer_t* create_for_file(cef_string_t* fileName);
    
    // CreateForHandler
    [DllImport(libcef.LibraryName, EntryPoint = "cef_stream_writer_create_for_handler", CallingConvention = libcef.CEF_CALL)]
