...
internal unsafe struct cef_command_line_t
{
    ...
    // CreateCommandLine
    [DllImport(libcef.LibraryName, EntryPoint = "cef_command_line_create", CallingConvention = libcef.CEF_CALL)]
    public static extern cef_command_line_t* create();
    
    // GetGlobalCommandLine
    [DllImport(libcef.LibraryName, EntryPoint = "cef_command_line_get_global", CallingConvention = libcef.CEF_CALL)]
