...
internal static unsafe partial class libcef
{
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_list_alloc", CallingConvention = CEF_CALL)]
    public static extern cef_string_list* string_list_alloc();

    // Return the number of elements in the string list.
    [DllImport(LibraryName, EntryPoint = "cef_string_list_size", CallingConvention = CEF_CALL)]
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_list_value", CallingConvention = CEF_CALL)]
    ...
    [DllImport(LibraryName, EntryPoint = "cef_string_list_append", CallingConvention = CEF_CALL)]
    public static extern void string_list_append(cef_string_list* list, cef_string_t* value);

    // Clear the string list.
    [DllImport(LibraryName, EntryPoint = "cef_string_list_clear", CallingConvention = CEF_CALL)]
    public static extern void string_list_clear(cef_string_list* list);

    // Free the string list.
    [DllImport(LibraryName, EntryPoint = "cef_string_list_free", CallingConvention = CEF_CALL)]
    public static extern void string_list_free(cef_string_list* list);

    // Creates a copy of an existing string list.
    [DllImport(LibraryName, EntryPoint = "cef_string_list_copy", CallingConvention = CEF_CALL)]
